    ...
    <section className="contact max-container contact_bg px-4 md:px-6 py-10 pb-20 mt-4 text-white">
      <div className="max-w-screen-normal mx-auto flex flex-col lg:flex-row gap-4">
        <div className="w-full lg:w-1/2">
          ...
          <p className='mt-4 text-[17px] text-neutral-900 max-w-xl'>Bereit für eine Veränderung in Ihrem Unternehmen? Ich bin hier, um Ihre Ideen Wirklichkeit werden zu lassen! Lassen Sie uns in einem unverbindlichen Gespräch darüber sprechen, wie wir gemeinsam etwas Großartiges erreichen können.</p>
